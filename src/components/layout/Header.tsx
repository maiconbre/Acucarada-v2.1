          ...
          <div className="hidden md:flex items-center mr-6">
            <Link to="/">
              <img 
                src={logoImage} 
                alt="Açucarada Logo" 
                className="h-12 lg:h-14 w-auto object-contain transition-transform hover:scale-105"
                width="64"
                height="64"
                loading="lazy"
                decoding="async"
            ...
            <div className="ml-16 inline-flex items-center gap-1 bg-rose-primary/10 backdrop-blur-sm text-rose-primary px-2 py-1 rounded-full border border-rose-primary/20">
              ...
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuLink asChild>
                    <Link to="/" className="text-brown-primary hover:text-brown-primary transition-smooth px-3 py-2 rounded-md hover:bg-brown-primary/10 font-text">
                      Início
                    </Link>
                  </NavigationMenuLink>
                </NavigationMenuItem>
                <NavigationMenuItem>
                  <NavigationMenuLink asChild>
                    <Link to="/catalog" className="text-brown-primary hover:text-brown-primary transition-smooth px-4 py-2 rounded-md hover:bg-brown-primary/10 font-text text-sm h-10 flex items-center">
                      Catálogo
                    </Link>
                  </NavigationMenuLink>
                </NavigationMenuItem>
                <NavigationMenuItem>
                  <NavigationMenuLink asChild>
                    <Link to="/sobre" className="text-brown-primary hover:text-brown-primary transition-smooth px-4 py-2 rounded-md hover:bg-brown-primary/10 font-text text-sm h-10 flex items-center">
                      Sobre
                    </Link>
                  </NavigationMenuLink>
                </NavigationMenuItem>
                <NavigationMenuItem>
                  <NavigationMenuLink asChild>
                    <Link to="/contato" className="text-brown-primary hover:text-brown-primary transition-smooth px-4 py-2 rounded-md hover:bg-brown-primary/10 font-text text-sm h-10 flex items-center">
                      Contato
                    </Link>
                  </NavigationMenuLink>
                </NavigationMenuItem>
              ...
              <div className="flex items-center">
                {isSearchOpen ? (
                  ...
                  <Button
                    ...
                    size="lg"
                    onClick={handleSearchToggle}
                    className="text-brown-primary hover:bg-brown-primary/10 h-10 w-10"
                  >
